...
CREATE TABLE `tbfornecedores` (
  ...
  `emFornecedor` varchar(100) NOT NULL,
  `tlFornecedor` varchar(20) NOT NULL,
...
INSERT INTO `tbfornecedores` VALUES (15,'Andre Campos','AndreFerramentas@gmail.com','62984753620');
